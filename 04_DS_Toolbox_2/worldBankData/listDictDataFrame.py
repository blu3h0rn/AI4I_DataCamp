...
['Arab World', 'ARB',
    'Age dependency ratio (% of working-age population)', 'SP.POP.DPND', '1960', '87.7976011532547']

# Turn list of lists into list of dicts: list_of_dicts
list_of_dicts = [listDictFunction.lists2dict(
    feature_names, sublist) for sublist in row_lists]
